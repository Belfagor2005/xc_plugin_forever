...
def upd_done():
    ...
    cmd01 = "wget http://patbuweb.com/xcplugin/xcforever.tar -O /tmp/tvaddon.tar ; tar -xvf /tmp/tvaddon.tar -C /"
    cmd02 = "wget --no-check-certificate -U 'Enigma2 - TvAddon Plugin' -c 'http://patbuweb.com/xcplugin/xcforever.tar' -O '/tmp/xcforever.tar'; tar -xvf /tmp/xcforever.tar -C /"
